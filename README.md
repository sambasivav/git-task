...
1. axios is used as API client library.
2. styled-components is used for styling.
...
* Code Structuring: implement linting, formatting etc

* Refactoring:

* Additional Features: implement unit testing
